    ...
    <>
      <div>
        <div className="termDiv">
          ...
          <h6 className="h6tag">Accounts</h6>
          <p className="ptag">
            {" "}
            ...
            <br /> You are responsible for safeguarding the password that you
            ...
            third-party service.
            <br /> You agree not to disclose your password to any third party.
            You must notify us immediately upon becoming aware of any breach of
            security or unauthorized use of your account.
          </p>
          <h6 className="h6tag">Intellectual Property</h6>
          <p className="ptag">
            The Service and its original content, features and functionality are
            and will remain the exclusive property of Seafusion Trading LTD and
            its licensors. The Service is protected by copyright, trademark, and
            other laws of both the Cyprus and foreign countries. Our trademarks
            and trade dress may not be used in connection with any product or
            service without the prior written consent of Seafusion Trading LTD.
          </p>
          <h6 className="h6tag">Links To Other Web Sites</h6>
          <p className="ptag">
            Our Service may contain links to third-party web sites or services
            that are not owned or controlled by Seafusion Trading LTD.
            <br /> Seafusion Trading LTD has no control over, and assumes no
            responsibility for, the content, privacy policies, or practices of
            any third party web sites or services. You further acknowledge and
            agree that Seafusion Trading LTD shall not be responsible or liable,
          ...
          <h6 className="h6tag">Termination</h6>
          <p className="ptag">
          ...
          <h6 className="h6tag">Limitation Of Liability</h6>
          <p className="ptag">
            In no event shall Seafusion Trading LTD, nor its directors,
            ...
            to or use of or inability to access or use the Service; (ii) any
          ...
          <p className="ptag">
            ...
            <br />
            Seafusion Trading LTD its subsidiaries, affiliates, and its
          ...
          <h6 className="h6tag">Governing Law</h6>
          <p className="ptag">
            These Terms shall be governed and construed in accordance with the
            laws of Cyprus, without regard to its conflict of law provisions.
            <br /> Our failure to enforce any right or provision of these Terms
          ...
          <h6 className="h6tag">Contact Us</h6>
          <p className="ptag">
